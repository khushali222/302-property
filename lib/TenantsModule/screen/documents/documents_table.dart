...
class DocumentsInsuranceTable extends StatefulWidget {
  @override
  _DocumentsInsuranceTableState createState() => _DocumentsInsuranceTableState();
}
          ...
          children: <Widget>[
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Text("Policy Id", style: TextStyle(color: Colors.white,fontSize: 14)),
                    ),
                    SizedBox(width: 5),
                    /* ascending2
                        ? Padding(
            ...
            Expanded(
              ...
              child: InkWell(
                ...
                child: Row(
                  children: [
                    Text("Expiration\nDate", style: TextStyle(color: Colors.white,fontSize: 14),textAlign: TextAlign.center,),
                    SizedBox(width: 5),
                    /*ascending3
                        ? Padding(
                      padding: const EdgeInsets.only(top: 7, left: 2),
    ...
    Alert(
      ...
      buttons: [
        ...
        DialogButton(
          ...
          onPressed: () async {
             var data = await InsuranceRepository().deleteInsurancesProperties(id);
                            ...
                            Container(
                              ...
                              child: Column(
                                children: currentPageData
                                  ...
                                  Insurance_data Propertytype = entry.value;
