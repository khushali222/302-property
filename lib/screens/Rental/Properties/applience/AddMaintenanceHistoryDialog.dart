...
class AddMaintenanceHistoryDialog extends StatefulWidget {
  ...
  @override
  _AddMaintenanceHistoryDialogState createState() => _AddMaintenanceHistoryDialogState();
}

class _AddMaintenanceHistoryDialogState extends State<AddMaintenanceHistoryDialog> {
  ...
  Future<String?> _getAdminId() async {
    try {
      ...
      return prefs.getString('admin_id') ?? prefs.getString('id');
    } catch (e) {
