...
class _Insurance_premium_TableState extends State<Insurance_premium_Table> {
  ...
  void _openAddPremiumForm() {
    ...
    // TODO: Navigate to Add Insurance Premium form
    // Navigator.push(
    //   context,
    //   MaterialPageRoute(
    //     builder: (context) => Add_insurance_premium(
    ...
    Fluttertoast.showToast(
      msg: "Add Insurance Premium form coming soon",
  ...
  Future<void> _deletePremiumRecord(String id) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('${Api_url}/api/rentals/insurance-premiums/$id'),
        headers: {
          'Content-Type': 'application/json',
          'authorization': 'CRM $token',
          'id': 'CRM $adminId',
  ...
  void _editPremium(Map<String, dynamic> premium) {
    // TODO: Navigate to Edit Insurance Premium form
    // Navigator.push(
    //   context,
    //   MaterialPageRoute(
    //     builder: (context) => Add_insurance_premium(
    ...
    // });
    Fluttertoast.showToast(
      msg: "Edit Insurance Premium form coming soon",
      backgroundColor: Colors.blue,
      textColor: Colors.white,
    );
  }
