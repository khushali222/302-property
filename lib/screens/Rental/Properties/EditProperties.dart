  ...
  Future<void> fetchDetails1(String rentalId) async {
    try {
      ...
      setState(() {
        ...
        // Load insured values
        if (fetchedDetails.insuredValues != null &&
            fetchedDetails.insuredValues!.isNotEmpty) {
          historicalInsuredValues.clear();
          for (var insuredValue in fetchedDetails.insuredValues!) {
...
//                       },
                      ...
                      onTap: () async {
                        ...
                        List<add_prop.InsuredValue> insuredValuesList = [];
                        for (var item in historicalInsuredValues) {
                          if (item.year != null &&
                            ...
                            insuredValuesList.add(add_prop.InsuredValue(
                              year: item.year,
                        ...
                        // Set placedInService and insuredValues using dynamic access
                        try {
                          (properties as dynamic).placedInService =
                              formattedPlacedInService;
                          (properties as dynamic).insuredValues =
                              insuredValuesList.isNotEmpty
                                  ? insuredValuesList
                                  : null;
                        } catch (e) {
                          print(
                              'Error setting placedInService/insuredValues: $e');
                        }
