...
//  List<List<TextEditingController>> propertyGroupControllers = [];
 ...
 // }
  ...
  void sortDatarent(List<Rentals> data) {
    if (sorting1rent) {
      data.sort((a, b) => ascending1rent
          ? a.rentalOwnerFirstName!.compareTo(b.rentalOwnerFirstName!)
          : b.rentalOwnerFirstName!.compareTo(a.rentalOwnerFirstName!));
    } else if (sorting2rent) {
      data.sort((a, b) => ascending2rent
          ? a.rentalOwnerPhoneNumber!.compareTo(b.rentalOwnerPhoneNumber!)
          : b.rentalOwnerPhoneNumber!.compareTo(a.rentalOwnerPhoneNumber!));
    } else if (sorting3rent) {
      data.sort((a, b) => ascending3rent
  ...
  void _changeRowsPerPagerent(int selectedRowsPerPage) {
    setState(() {
      ...
      _currentPagerent = 0; // Reset to the first page when changing rows per page
    });
  }

  void _sortrent<T>(Comparable<T> Function(Rentals d) getField,
      int columnIndex, bool ascending) {
    setState(() {
  ...
  void handleEdit(Rentals rentalOwner) async {
    // Handle edit action
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //               child: Center(
            //                   child: Text(
            //                 '${widget.properties.Rentals?.rentalOwnerBuisinessNumber}',
            //                 style: const TextStyle(
            //                   color: Color.fromRGBO(21, 43, 81, 1),
            //                 ),
            //               )),
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (searchValuerent == null || searchValuerent!.isEmpty) {
                        ...
                        data = snapshot.data!
                            .where((rentals) => rentals.rentalOwnerFirstName!
                            .toLowerCase()
                        ...
                        data = snapshot.data!
                            .where((rentals) =>
                        rentals.rentalOwnerFirstName == searchValuerent)
                            .toList();
                      }
                      sortDatarent(data);
                            ...
                            Container(
                              ...
                              child: Column(
                                children: currentPageData
                                    ...
                                    .map((entry) {
                                  int index = entry.key;
                                  bool isExpandedrent = expandedIndex == index;
            ...
            if (MediaQuery.of(context).size.width > 500)
              ...
              //                     ),
              //                     for (var i = 0; i < _pagedDatarent.length; i++)
              //                       TableRow(
              //                         decoration: BoxDecoration(
              //                           border: Border(
              //                             left: BorderSide(
              ...
              //                         children: [
              //                           _buildDataCell(
              //                               _pagedDatarent[i].rentalOwnername ?? "",
              //                               _pagedDatarent[i].rentalownerId!),
              //                           // _buildDataCell('${_pagedDatarent[i].rentalOwnerFirstName ?? ''} ${_pagedDatarent[i].rentalOwnerLastName ?? ''}'),
              //                           _buildDataCell(
              //                               _pagedDatarent[i]
              ...
              //                           // TableCell(child: Text('yash')),
              //
              //                           _buildActionsCell(_pagedDatarent[i]),
              //                         ],
              //                       ),
              //                   ],
              //                 ),
                      ...
                      tenants.length,
                          (index) => Material(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.white, // Change as per your need
                                borderRadius: BorderRadius.circular(10),
                              ),
                      ...
                      SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child:  Image(
                            ...
                            fit: BoxFit.cover,
                            height: MediaQuery.of(context).size.width < 500 ? 150 :220,
