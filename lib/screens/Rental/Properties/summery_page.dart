            ...
            child: TabBar(
              ...
              tabs: [
                ...
                StatefulBuilder(builder: (BuildContext context, void Function(void Function()) setState) {
                  return Tab(text: '  Tenant(${Provider.of<Tenants_counts>(context,listen: false).count}  )  '
                  );
                  },
                ),
              ],
              ...
              GestureDetector(
                      ...
                      return StatefulBuilder(
                        builder: (BuildContext context,
                          ...
                          return AlertDialog(
                            ...
                            content: SingleChildScrollView(
                             ...
                             Column(
                               children: [
                                   Row(
                                     children: [
                                     Text("Add Unit Details",style: TextStyle(
                                       color:  Color.fromRGBO(21, 43, 81, 1),
                                       fontWeight: FontWeight.bold,
                                     ),),
                                       Spacer(),
                            ...
                            Row(
                              children: [
                                Text("Unit Number",style: TextStyle(color: Color(0xFF8A95A8),fontWeight: FontWeight.bold),),
                              ],
                            ),
                                 SizedBox(
                                   height: 10,
                            ...
                            Padding(
                              ...
                              child: Material(
                                ...
                                child: TextFormField(
                                 ...
                                 Row(
                                   children: [
                                     Text("Street Address",style: TextStyle(color: Color(0xFF8A95A8),fontWeight: FontWeight.bold),),
                                   ],
                                 ),
                                 Padding(
                                   padding: const EdgeInsets.symmetric(vertical: 1),
                                 ...
                                 Row(
                                   children: [
                                     Text("SQFT",style: TextStyle(color: Color(0xFF8A95A8),fontWeight: FontWeight.bold),),
                                   ],
                                 ),
                                 Padding(
                                   padding: const EdgeInsets.symmetric(vertical: 1),
                                      ...
                                      onTap: (){},
                                       child: Material(
                                         ...
                                         child: Container(
                                           ...
                                           child: Center(child: Text("Save",style: TextStyle(fontWeight: FontWeight.w500,color: Colors.white),)),
                                         ),
                                       ),
                                     ),
                                     SizedBox(width:10),
                                     GestureDetector(
                                       ...
                                       child: Material(
                                         ...
                                         child: Container(
                                           ...
                                           child: Center(child: Text("Cancel",style: TextStyle(fontWeight: FontWeight.w500,color: Color
                                               .fromRGBO(
                                               21,
                                               43,
                                               81,
                ...
                child: Material(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Add Unit",style: TextStyle(fontWeight: FontWeight.w500,color: Color
                        .fromRGBO(
                        21,
                        43,
                        81,
