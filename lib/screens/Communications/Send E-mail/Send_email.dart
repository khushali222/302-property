...
class Send_Email_templet extends StatefulWidget {
  @override
  _Send_Email_templetState createState() => _Send_Email_templetState();
}

class _Send_Email_templetState extends State<Send_Email_templet> {
  List<Map<String, dynamic>> templates = [];
  List<String> events = [];
