...
void main() {
  runApp(
    DevicePreview(
      ...
      builder: (context) => Properties_table(),
    ),
  );
}
*/
...
class Properties_table extends StatefulWidget {
  ...
  // final int index;
  // Properties_table({required this.data, required this.index});
  @override
...
class _Properties_tableState extends State<Properties_table> {
  ...
  void handleEdit(Rentals rentals) async {
    // Handle edit action
    print('Edit ${rentals.rentalId}');
  ...
  void sortData(List<Rentals> data) {
    if (sorting1) {
      ...
      data.sort((a, b) => ascending2
          ? a.propertyTypeData!.propertyType!.compareTo(b.propertyTypeData!.propertyType!)
          : b.propertyTypeData!.propertyType!.compareTo(a.propertyTypeData!.propertyType!));
    } else if (sorting3) {
      data.sort((a, b) => ascending3
          ? a.propertyTypeData!.propertySubType!.compareTo(b.propertyTypeData!.propertySubType!)
          : b.propertyTypeData!.propertySubType!.compareTo(a.propertyTypeData!.propertySubType!));
    }
  }
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: '${rentals.rentalOwnerData!.rentalOwnerFirstName}',
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: '${rentals.rentalOwnerData!.city}',
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: '${rentals.rentalOwnerData!.rentalOwnerPhoneNumber}',
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: formatDate('${rentals.updatedAt}'),
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: '${rentals.rentalOwnerData!.rentalOwnerCompanyName}',
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: '${rentals.rentalOwnerData!.rentalOwnerPrimaryEmail}',
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
                                                            ...
                                                            Text.rich(
                                                              TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: formatDate('${rentals.createdAt}'),
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                        FontWeight
                                                                            .w700,
          ...
          children: <Widget>[
            ...
            Expanded(
              child: InkWell(
                ...
                child: Row(
                  children: [
                    Text("   Property\n  SubType", style: TextStyle(color: Colors.white)),
                    SizedBox(width: 5),
                    ascending3
                        ? Padding(
                      padding: const EdgeInsets.only(top: 7, left: 2),
