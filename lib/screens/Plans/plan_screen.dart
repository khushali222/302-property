...
class _getPlanDetailScreenState extends State<getPlanDetailScreen> {
  ...
  String formatdateplan(String date) {
    try {
      DateTime parsedDate;

      // Check if the date is in "MM/yy" format
      if (date.contains('/')) {
        parsedDate = DateFormat('MM/yy').parse(date);
      }
      // Else assume the date is in "yyyy-MM-dd" format
      else {
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                             SizedBox(height: 10,),
                                              ...
                                              //                 color: Color.fromRGBO(
                                              //                     138, 149, 168, 1)),),
                                              //             Expanded(child: Text( formatDate(
                                              //                 data.purchaseDate!),style: TextStyle(
                                              //                 fontSize: 12,
                                              //                 fontWeight:
                                              //                 FontWeight.bold,
                                              //                 color: blueColor),)),
                                              ...
                                              //               .start,
                                              //           children: [
                                              //             Text("Billing Peiriod  :",style: TextStyle(
                                              //                 fontSize: 12,
                                              //                 fontWeight:
                                              //                 FontWeight.bold,
                                              //                 color: Color.fromRGBO(
                                              //                     138, 149, 168, 1)),),
                                              //             Text("\$${data.planDetail?.billingInterval}",style: TextStyle(
                                              //                 fontSize: 12,
                                              //                 fontWeight:
                                              //                 FontWeight.bold,
                                              //                 color: blueColor),),
                                              ...
                                              //               color: Color.fromRGBO(
                                              //                   138, 149, 168, 1)),),
                                              //           Expanded(child: Text("${data.planDetail?.planName}",style: TextStyle(
                                              //               fontSize: 12,
                                              //               fontWeight:
                                              //               FontWeight.bold,
                                              //               color: blueColor),)),
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                TextStyle(
                                                                              color: workOrder.isActive == true ? Colors.green : blueColor,
                                                                              fontWeight: FontWeight.bold,
                                                                              fontSize: 14,
                                                                            ),
                                                                          ),
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                TextStyle(
                                                                              color: workOrder.isActive == true ? Colors.green[800] : blueColor,
                                                                              fontWeight: FontWeight.bold,
                                                                              fontSize: 14,
                                                                            ),
                                                                          ),
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            ' ${formatdateplan(workOrder.expirationDate!)}',
                                                                            style:
                                                                                TextStyle(
                                                                              color: workOrder.isActive == true ? Colors.green[800] : blueColor,
                                                                              fontWeight: FontWeight.bold,
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    leftValue,
                    style: TextStyle(color: blueColor,fontSize: 12,fontWeight: FontWeight.bold),
                  ),
                ),
              ],
            ),
