  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _connectivityResult != ConnectivityResult.none
          ? Column(
              children: [
                ReportHeader(title: "Open Work Order"),
                Expanded(
                                                                      ...
                                                                      Text.rich(
                                                                        TextSpan(
                                                                          children: [
                                                                            ...
                                                                            TextSpan(
                                                                              text: '${(workOrder.workSubject == null || workOrder.workSubject!.isEmpty) ? '-' : workOrder.workSubject}',
                                                                      ...
                                                                      Text.rich(
                                                                        TextSpan(
                                                                          children: [
                                                                            ...
                                                                            TextSpan(
                                                                              text: '${(workOrder.workPerformed == null || workOrder.workPerformed!.isEmpty) ? '-' : workOrder.workPerformed}',
                                                                              style: TextStyle(fontWeight: FontWeight.w700, color: grey), // Light and grey
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ...
                                                                      Text.rich(
                                                                        TextSpan(
                                                                          children: [
                                                                            ...
                                                                            TextSpan(
                                                                              text: '${(workOrder.vendorNotes == null || workOrder.vendorNotes!.isEmpty) ? '-' : workOrder.vendorNotes}',
                                                                              style: TextStyle(fontWeight: FontWeight.w700, color: grey), // Light and grey
                                                                            ),
                                                                          ],
                                                                        ),
