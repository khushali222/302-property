  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _connectivityResult != ConnectivityResult.none
          ? Column(
              children: [
                ReportHeader(title: "Renter's Insurance"),
                Expanded(
                                                                      ...
                                                                      if (item.tenantName
                                                                        ...
                                                                        TextSpan(
                                                                          ...
                                                                          style:
                                                                              TextStyle(
                                                                            color:
                                                                                Colors.lightBlue, // Light blue color for tenant names
                                                                            fontWeight:
                                                                                FontWeight.bold,
                                                                            fontSize:
                                                                                11,
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        buildTableRow(
                                                                          'Effective Date :',
                                                                          getDisplayValue(item.rentersInsurance?.effectiveDate?.isNotEmpty == true
                                                                              ? dateProvider.formatCurrentDate('${item.rentersInsurance?.effectiveDate?.split('T').first}')
                                                                              : 'N/A'),
                                                                          'Expiration Date :',
                                                                          getDisplayValue(item.rentersInsurance?.expirationDate?.isNotEmpty == true
                                                                              ? dateProvider.formatCurrentDate('${item.rentersInsurance?.expirationDate?.split('T').first}')
                                                                              : 'N/A'),
                                                                        ),
                                                                        buildTableRow(
                                                                            'Liability Coverage :',
                                                                            getDisplayValue(item.rentersInsurance?.liabilityCoverage != null
                                                                                ? formatCurrency(item.rentersInsurance!.liabilityCoverage.toDouble())
                                                                                : 'N/A'),
                                                                            '',
                                                                            '')
