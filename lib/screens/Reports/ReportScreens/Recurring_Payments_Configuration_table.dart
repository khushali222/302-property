...
class _Recurring_Payments_Configuration_ReportState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ReportHeader(title: "Recurring Payments Configuration"),
            Expanded(
              child: isLoading
                  ? Center(
                                    ...
                                    padding: EdgeInsets.only(
                                        ...
                                        right:
                                            MediaQuery.of(context).size.width >
                                                ...
                                                : 16),
                                    child: Column(
                                      children: recurringPaymentsConfiguration!
                                          .data!
                                          .asMap()
                                          .entries
                                          .map((leaseData) {
                                                                ...
                                                                children: <Widget>[
                                                                  GestureDetector(
                                                                    onTap: () {
                                                                      setState(
                                                                          () {
                                                                        if (expandedTenantIndex["${rowIndex}${LeaserowIndex}"] ==
                                                                            tenantIndex.toString()) {
                                                                          expandedTenantIndex["${rowIndex}${LeaserowIndex}"] =
                                                                              null;
                                                                        } else {
                                                                          expandedTenantIndex["${rowIndex}${LeaserowIndex}"] =
                                                                              tenantIndex.toString();
