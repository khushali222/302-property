                                              ...
                                              title: Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Expanded(
                                                      child: Text(
                                                        item.tenantDetails != null && item.tenantDetails!.isNotEmpty
                                                            ? item.tenantDetails!
                                                            .map((tenant) =>
                                                                ...
                                                                TextSpan(
                                                                  children: [
                                                                    ...
                                                                    TextSpan(
                                                                      ...
                                                                      text: item.effectiveDate?.isNotEmpty ==
                                                                              true
                                                                          ? dateProvider
                                                              ...
                                                              child:
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  var check = await Navigator.push(
                                                                      ...
                                                                      MaterialPageRoute(
                                                                          builder: (context) =>
                                                                          EditRentersInsurance(tenantid: widget.tenantId, leaseId: widget.leaseId,)));
                                                                  if (check ==
                                                                      true) {
                                                                    setState(
                                                                            () {
