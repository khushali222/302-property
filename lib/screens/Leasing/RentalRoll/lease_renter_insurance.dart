...
class _RentersInsuranceState extends State<RentersInsurance> {
  ...
  Future<List<lease_renter_insurance>> fetchRentersInsuranceData() async {
    ...
    try {
      List<lease_renter_insurance> data = await service.fetchRentersInsurance();
      setState(() {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: InkWell(
                ...
                child: Row(
                  children: [
                    Text("Insurance\n Provider", style: TextStyle(color: Colors.white)),
                    SizedBox(width: 5),
                    ascending2
                        ? Padding(
                                                          ...
                                                          Text.rich(
                                                            TextSpan(
                                                              children: [
                                                                ...
                                                                TextSpan(
                                                                  text: item?.effectiveDate?.isNotEmpty == true
                                                            ...
                                                            TextSpan(
                                                              children: [
                                                                ...
                                                                TextSpan(
                                                                  ...
                                                                  text: item?.expirationDate?.isNotEmpty == true
                                                            ...
                                                            TextSpan(
                                                              children: [
                                                                ...
                                                                TextSpan(
                                                                  // text: formatDate(
                                                                  //     '${Propertytype.updatedAt}'),
                                                                  text: item?.liabilityCoverage.toString().isNotEmpty == true
                                                                      ? item?.liabilityCoverage.toString()
                                                                      : 'N/A',
                                                                  style: TextStyle(
                                                                      fontWeight:
                                                                      FontWeight
