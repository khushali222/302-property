...
class _Lease_tableState extends State<Lease_table> {
  ...
  //   print(' end date like diffrence ${edate}');
  ...
  String daydifference(String endDate) {
    ...
    DateTime normalizedEndDate = DateTime(edate.year, edate.month, edate.day);
    DateTime normalizedNow = DateTime(now.year, now.month, now.day);

    int difference = normalizedEndDate.difference(normalizedNow).inDays;
