                  ...
                  children: [
                    ...
                    TableRow(
                      children: [
                        ...
                        buildTableCell(Text(
                            '${tenant.data?.startDate} ${tenant.data?.endDate}')),
                      ],
                    ),
                  ],
                ),
                ...
                children: [
                  TableRow(
                    children: [
                      ...
                      buildTableCell(Text(
                          '${tenant.data?.tenantData?.first.tenantFirstName} ${tenant.data?.tenantData?.first.tenantLastName}')),
                    ],
                  ),
                  TableRow(
                    children: [
