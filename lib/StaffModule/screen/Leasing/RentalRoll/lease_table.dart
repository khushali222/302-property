                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (MediaQuery.of(context).size.width < 500)
                          SizedBox(width: permissions!.leaseAdd! ? 6 : 0),
                        if (MediaQuery.of(context).size.width > 500)
                          SizedBox(width: 22),
                      ],
                    ),
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            if (searchValue == null || searchValue!.isEmpty) {
                              ...
                              data = snapshot.data!
                                  .where((lease) =>
                                      lease.rentalAddress!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.tenantNames!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.rentCycle!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.startDate!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.endDate!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.amount!.toStringAsFixed(2).toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.remainingDays!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.rentDueDate!.toLowerCase().contains(
                                          searchValue!.toLowerCase()) ||
                                      lease.totalBalance!
                                          .toStringAsFixed(2)
                                          .toLowerCase()
