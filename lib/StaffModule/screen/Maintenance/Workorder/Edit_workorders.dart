                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          if (imageFile is String) {
                            // This is a network image URL, update it
                            _imageUrls[imageIndex] = imageFile;
                          } else {
                            _images[imageIndex] = imageFile;
                          }
                        });

                        // Upload the new image if it's a file
                        if (originalFile != null) {
                          try {
                            String? fileName = await uploadImage(originalFile);
                            if (fileName != null &&
                                      ...
                                      children: [
                                        ...
                                        DropdownButtonHideUnderline(
                                          child: DropdownButtonFormField2<String>(
                                            ...
                                            buttonStyleData: WorkorderDropdownTheme.formButtonStyle(),
                                            iconStyleData: WorkorderDropdownTheme.iconStyle,
                                            dropdownStyleData: WorkorderDropdownTheme.panelStyle(),
                                            menuItemStyleData: WorkorderDropdownTheme.menuItemStyle,
                                            validator: (value) {
