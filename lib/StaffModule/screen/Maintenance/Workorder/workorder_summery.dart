  ...
  Summery_page(WorkOrderData_summery summery) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth > 600) {
        ...
        final workOrderUpdates = summery.workorderUpdates ?? [];
        return SingleChildScrollView(
          child: Container(
            padding: EdgeInsets.symmetric(horizontal: 10),
            child: Column(
                                ...
                                if ((summery.workorderUpdates?.isNotEmpty ??
                                  ...
                                  Text(
                                      ...
                                      style: TextStyle(
                                          color: blueColor,
                                          fontWeight: FontWeight.bold)),
                                if ((summery.workorderUpdates?.isEmpty ?? true))
                                  Text(
                                      '${(summery.date?.isEmpty ?? true) ? "N/A" : summery.date?.toString()}',
                                      style: TextStyle(
                                          color: blueColor,
                                          fontWeight: FontWeight.bold)),
                                SizedBox(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                  child: Text(
                                '${(summery.vendorNotes?.isNotEmpty ?? false) ? summery.vendorNotes : "N/A"}',
                                style: TextStyle(color: blueColor),
                              )),
                            ],
                          ),
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Checkbox(
                                    ...
                                    activeColor:
                                        isChecked ? Colors.black : blueColor,
                                  ),
                                ),
                                SizedBox(
                                  width: 15,
