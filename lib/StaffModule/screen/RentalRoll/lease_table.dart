...
class _Lease_tableState extends State<Lease_table> {
 ...
 /* void handleTap(RentalOwnerSummey rentalownersummery) async {
  ...
  Future<void> fetchLeaseadded() async {
    ...
    final response =
        await http.get(Uri.parse('${Api_url}/api/leases/limitation/$admin_id'),
                                                      ...
                                                      child: Text.rich(
                                                        TextSpan(
                                                          children: [
                                                            ...
                                                            if(lease.tenantNames != "" && lease.tenantNames != null && lease.tenantNames!.isNotEmpty)
                                                            TextSpan(
                                                              text:"\n${lease.tenantNames}",
                                                              style: TextStyle(
                                                                color: blueColor,// Light blue color for tenant names
                                                                fontWeight: FontWeight.bold,
                                                                fontSize: 11,
                                                              ),
                                                            ),
