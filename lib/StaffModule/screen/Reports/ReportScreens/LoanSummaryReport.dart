  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          StaffReportHeader(title: 'Loan Summary Report'),
          _buildFilterRow(),
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  icon: const Padding(
                    ...
                    child: Icon(Icons.keyboard_arrow_down, color: Color(0xFF8A95A8)),
                  ),
                ),
              ),
            ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: _detailField('Properties :', item.propertyCount.toString())),
                              Expanded(child: _detailField('Property Value :', _fmtCurrency(item.propertyValue))),
                            ],
                          ),
                          ...
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: _detailField('Balance :', _fmtCurrency(item.remainingBalance))),
                              Expanded(child: _detailField('LTV :', _fmtLtv(item.ltvPercent))),
                            ],
                          ),
                          const SizedBox(height: 6),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: _detailField('NOI :', _fmtCurrency(item.noi))),
                              Expanded(child: _detailField('Debt Service :', _fmtCurrency(item.debtService))),
                            ],
                          ),
                          const SizedBox(height: 6),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: _detailField('DSCR :', item.dscr.toStringAsFixed(2))),
                              Expanded(child: _detailField('Start Date :', _fmtDate(item.startDate))),
                            ],
                          ),
                          const SizedBox(height: 6),
                          _detailField('End Date :', _fmtDate(item.endDate)),
