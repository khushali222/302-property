...
class _InsurancePremiumReportState extends State<InsurancePremiumReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: CustomDrawerStaff(currentpage: "Reports", dropdown: true),
      body: Column(
        children: [
  ...
  Future<void> _generateExcel() async {
    ...
    try {
      ...
      sheet
          .getRangeByName(
              'A1:${String.fromCharCode(64 + reportData!.years.length + 1)}1')
          .merge();
      ...
      sheet
          .getRangeByName(
              'A3:${String.fromCharCode(64 + reportData!.years.length + 1)}3')
          .merge();
      ...
      sheet
          .getRangeByName(
              'A5:${String.fromCharCode(64 + reportData!.years.length + 1)}5')
          .merge();
