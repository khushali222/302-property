...
class _DailyTransactionsState extends State<DailyTransactions> {
  ...
  Future<DailyTransactionReportData> fetchDelinquentTenantsData(String fromDate, String toDate, {String? charge}) async {
    try {
      ...
      DailyTransactionReportData data = await DailyTrasactionReportStaff().fetchDailyTransactionsstaff(id!, reverseFormatDate(fromDate), reverseFormatDate(toDate), chargetype: chargedata);
