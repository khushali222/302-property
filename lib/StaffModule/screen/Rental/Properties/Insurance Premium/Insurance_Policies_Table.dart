                                                      ...
                                                      children: [
                                                        ...
                                                        if (policy.policyType != null && policy.policyType!.isNotEmpty)
                                                          _buildTableRow(
                                                            ...
                                                            'Named Insured:',
                                                            policy.namedInsured ?? 'N/A',
                                                          ),
                                                        if (policy.paymentTerms != null && policy.paymentTerms!.isNotEmpty)
                                                          _buildTableRow(
                                                            'Payment Terms:',
                                                            policy.paymentTerms ?? 'N/A',
                                                            'Deductible:',
                                                            policy.deductible != null
                                                                ? _formatCurrency(policy.deductible)
                                                                : 'N/A',
                                                          ),
                                                        if (policy.agentName != null && policy.agentName!.isNotEmpty)
                                                          _buildTableRow(
                                                            'Agent Name:',
                                                            policy.agentName ?? 'N/A',
                                                            'Agent Phone:',
                                                            policy.agentPhone ?? 'N/A',
                                                          ),
                                                        if (policy.agentEmail != null && policy.agentEmail!.isNotEmpty)
                                                          _buildTableRow(
                                                            'Agent Email:',
                                                            policy.agentEmail ?? 'N/A',
                                                            'Broker Name:',
                                                            policy.brokerName ?? 'N/A',
                                                          ),
                                                        if (policy.mailingAddress != null && policy.mailingAddress!.isNotEmpty)
                                                          _buildTableRow(
                                                            'Mailing Address:',
                                                            policy.mailingAddress ?? 'N/A',
                                                            '',
                                                            '',
                                                          ),
