...
class EditLease {
  ...
  factory EditLease.fromJson(Map<String, dynamic> json) {
    ...
    // leases omit fields like createdAt — parse defensively.
    ...
    return EditLease(
      ...
      leaseAmount: json['lease_amount'] is String
          ? double.parse(json['lease_amount'])
          : (json['lease_amount'] as num?)?.toDouble() ?? 0.0,
      uploadedFile: json['uploaded_file'] != null
          ? List<dynamic>.from(json['uploaded_file'])
          : [],
      ...
      moveoutTenant: json['moveout_tenant'] != null
          ? List<dynamic>.from(json['moveout_tenant'])
          : [],
