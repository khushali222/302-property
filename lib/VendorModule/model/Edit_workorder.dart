...
class PropertyData {
  ...
  PropertyData({this.sId, this.propertyName, this.address,this.rental_id});
...
class StaffData {
  ...
  StaffData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    staffName = json['staffmember_name'];
    staffmember_id = json['staffmember_id'];
    role = json['role'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['role'] = role;
    data['staffmember_id']=staffmember_id;
    return data;
  }
}
