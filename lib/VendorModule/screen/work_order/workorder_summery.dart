                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(height: 1, color: grey, width: double.infinity),
                    ...
                    children: [
                      ...
                      ...(summery.workorderUpdates ?? []).reversed.take(visibleCount).map((update) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(color: const Color(0xFFF7F9FC), border: Border.all(color: grey), borderRadius: BorderRadius.circular(12)),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Row(children: [
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("${summery.propertyData?.rentaladress ?? "N/A"} ${summery.unitData?.rental_unit != null ? '(${summery.unitData?.rental_unit})' : ''}", textAlign: TextAlign.center),
